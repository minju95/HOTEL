...
<body>
	...
	<form id="frm" name="frm" action="/hotel/admin/newRoom"
		...
		<div style="width:100%; text-align:center;" class="newRoom_form">
			<div style="border:1px solid red;">
				...
				<div style="float: left; margin-left: 100px;" class="form-group">
					...
					럭셔리 1회용 어메니티<br> <input type="checkbox" id="fac8" name="fac8"
						value="1회용 어메니티"> 1회용 어메니티<br> <input type="checkbox"
						id="fac9" name="fac9" value="전 객실 냉난방 시설 구비"> 전 객실 냉난방 시설
					구비<br> <input type="checkbox" id="fac10" name="fac10"
						value="객실 내 안전금고"> 객실 내 안전금고<br> <input
