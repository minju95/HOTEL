...
<div class="myForm-group">
	<div class="form-group">
	  ...
	  <input type="text" class="form-control" id="MEM_USERID" name="MEM_USERID" placeholder="아이디를 입력하세요">
	</div>
	<div id="id_check"></div>
	...
	<div class="form-group">
	  ...
	  <input type="text" class="form-control" id="MEM_PHONE" name="MEM_PHONE" placeholder="전화번호를 입력하세요">
	</div>
	<div id="phone_check"></div>
	<div class="form-group">
	  <label for="user_email">이메일 주소</label>
	  <div class="form-inline">
		  <input type="email" class="form-control" id="user_email" name="MEM_EMAIL" placeholder="이메일을 입력하세요">
	...
	<button type="button" class="btn btn-default btn-lg btn-block" id="signUpBtn">가입하기</button>
</div>
</form>
