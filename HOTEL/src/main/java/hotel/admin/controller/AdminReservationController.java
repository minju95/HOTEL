...
public class AdminReservationController {
	...
	public ModelAndView reservationList(CommandMap commandMap) throws Exception {
		...
		List<Map<String, Object>> list = adminReservationService.reservationList(commandMap.getMap());
	...
	//검색
	 ...
	 @RequestMapping(value ="/admin/selectReservationList") public ModelAndView
	 searchReservationList(CommandMap commandMap) throws Exception { ModelAndView
	 mv = new ModelAndView("jsonView"); //jsonView: 데이터를 json형식으로 변환해주는 역할
	 List<Map<String,Object>> list =
	 adminReservationService.selectReservationList(commandMap.getMap());
